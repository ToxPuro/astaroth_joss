...
>>>>>>> eee2be6 (general edits to improve the text, moved Johannes' notes to the end of the text to make the text less cluttered and removed some resolved comments. Disagree with the change on the runtime compilation section and expanded on why in a comment. Could we revert to the earlier one?)
